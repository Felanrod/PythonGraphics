...
def pullthehandle(Bet, Player_Money, Jack_Pot):
    ...
    # Match 3
    if Fruit_Reel.count("Energy") == 3:
        winnings,win = Bet*20,True
    elif Fruit_Reel.count("Sword") == 3:
        winnings,win = Bet*30,True
    elif Fruit_Reel.count("Starman") == 3:
        winnings,win = Bet*40,True
    elif Fruit_Reel.count("MMLife") == 3:
        winnings,win = Bet*100,True
    elif Fruit_Reel.count("Triforce") == 3:
        winnings,win = Bet*200,True
    elif Fruit_Reel.count("1Up") == 3:
    ...
    # Match 2
        ...
        if Fruit_Reel.count("Energy") == 2:
            if Fruit_Reel.count("MMLife") == 1:
                winnings,win = Bet*35,True
        if Fruit_Reel.count("Sword") == 2:
            if Fruit_Reel.count("Triforce") == 1:
                winnings,win = Bet*45,True
        elif Fruit_Reel.count("Starman") == 2:
            if Fruit_Reel.count("1Up") == 1:
                winnings,win = Bet*55,True
        elif Fruit_Reel.count("MMLife") == 2:
            if Fruit_Reel.count("Energy") == 1:
                winnings,win = Bet*50,True
        elif Fruit_Reel.count("Triforce") == 2:
            if Fruit_Reel.count("Sword") == 1:
                winnings,win = Bet*60,True
        elif Fruit_Reel.count("1Up") == 2:
            if Fruit_Reel.count("Starman") == 1:
                winnings,win = Bet*150,True
        ...
        # Match Lucky Seven
            ...
            winnings, win = Bet*30,True
        elif Fruit_Reel.count("Energy") == 1:
            if Fruit_Reel.count("Sword") == 1:
                if Fruit_Reel.count("Starman") == 1:
                    winnings, win = Bet*25,True
        elif Fruit_Reel.count("MMLife") == 1:
            if Fruit_Reel.count("Triforce") == 1:
                if Fruit_Reel.count("1Up") == 1:
