...
class PlaceGeometryApp:
    ...
    try:
        ...
        betSound = mixer.Sound("smb_coin.wav")
        spinSound = mixer.Sound("smb_flagpole.wav")
        winSound = mixer.Sound("smb_1_up.wav")
        gameOverSound = mixer.Sound("smb_gameover.wav")
        loseSound = mixer.Sound("smb_bowserfalls.wav")
    except:
        ...
        if self.bet != 0:
            if self.cash != 0:
                ...
                # No win
                    ...
                    #self.bg_panel.after(1500, self.PlayLoseSound())
                    self.loseSound.play()
