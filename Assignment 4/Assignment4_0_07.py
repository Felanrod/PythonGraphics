...
def game():
    ...
    while keepGoing:
        ...
        print scoreboard.addEnemyCounter, enemyThreshold, initialAEnemies, len(aEnemy), len(gEnemy)
        ...
        if scoreboard.addEnemyCounter >= enemyThreshold:
            if initialAEnemies == False:
                initialAEnemies = True
