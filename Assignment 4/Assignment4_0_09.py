...
class TitleScreen(pygame.sprite.Sprite):
    def __init__(self):
        ...
        for titleNum in range(3):
            ...
            #self.title[titleNum] = pygame.image.load(imgName)
            #self.title[titleNum] = self.title[titleNum].convert()
            #self.imgList.append(pygame.image.load("images/BMTitle{0}.gif", titleNum+1))
            
            #self.imgList.append(title[titleNum])
        self.image = self.imgList[0]
        self.rect = self.image.get_rect()
        self.rect.center = (320, 240)
        
        #self.title1 = pygame.image.load("images/BMTitle1.gif")
    def update(self):
        self.pause += 1
